...
access_token = '6355974422:AAFxsdBZNmDXU3ZW5LqY8TyXfEu5MFTGZls' #telegram
apikey = "ca06c1e43db582bd454d1ba26cdb9d7f" #openweather
city = "daegu"
lang = "kr"
lat = "37.5642135"
lon = "127.0016985"

full_Url = f"http://api.openweathermap.org/data/2.5/forecast?id=524901&q={city}&appid={apikey}&lang={lang}&units=metric"#openweather API(Current weather data)
